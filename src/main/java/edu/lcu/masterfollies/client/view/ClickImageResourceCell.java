package edu.lcu.masterfollies.client.view;
 ...
 */
public class ClickImageResourceCell extends AbstractCell<ImageResource> {
  
  /**
   * Construct a new ImageResourceCell.
   */
  public ClickImageResourceCell() {
	  super("click");
  }
  
  public ClickImageResourceCell(String text) {
	  super("click");
  }
